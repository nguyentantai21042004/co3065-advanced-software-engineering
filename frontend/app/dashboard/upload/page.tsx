  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">Upload your CV and let AI Coach analyze it for insights and recommendations</p>
      </div>
        ...
        <CardContent>
          {fileState.status === "idle" || fileState.status === "error" ? (
            <>
              ...
              >
                <Cloud className={`h-16 w-16 mx-auto mb-4 ${dragActive ? "text-blue-600" : "text-gray-400"}`} />
                <p className="text-lg font-semibold text-gray-900 mb-2">Drag and drop your CV here</p>
                <p className="text-sm text-gray-600 mb-4">PDF, DOCX, DOC (Max 10MB)</p>
              </div>
          ...
          {fileState.status === "uploading" && (
            <div className="space-y-4">
              <div className="flex items-center justify-between mb-4">
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-500">
                    {(fileState.file?.size || 0) / 1024 > 1024
                      ? ((fileState.file?.size || 0) / (1024 * 1024)).toFixed(2) + " MB"
                      : ((fileState.file?.size || 0) / 1024).toFixed(2) + " KB"}
                  </p>
                </div>
              ...
              <p className="text-sm text-gray-600 text-center">Uploading... {Math.round(fileState.progress)}%</p>
            </div>
          )}
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4 bg-green-50 border border-green-200 rounded-lg p-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-green-700 mt-1">Ready to extract and analyze your CV</p>
                </div>
              </div>
                ...
                <CardContent className="pt-6">
                  <div className="grid grid-cols-3 gap-4">
                    <div>
                      ...
                      <p className="text-sm font-semibold text-gray-900 truncate mt-1">{fileState.file?.name}</p>
                    </div>
                    <div>
                      <p className="text-xs font-medium text-gray-500 uppercase tracking-wider">File Size</p>
                      <p className="text-sm font-semibold text-gray-900 mt-1">
                        {fileState.file?.size && fileState.file.size / 1024 > 1024
                    ...
                    <div>
                      ...
                      <p className="text-sm font-semibold text-gray-900 mt-1">Just now</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <div className="flex gap-3 pt-2">
                ...
                <Button onClick={handleReset} variant="outline" className="flex-1 border-gray-300 bg-transparent">
                  Upload Another
                </Button>
              </div>
            </div>
      ...
      <Card className="bg-blue-50 border-blue-200">
        <CardContent className="pt-6">
          <div className="flex gap-4">
            ...
            <div>
              <p className="font-semibold text-blue-900 text-sm">Supported file formats</p>
              <p className="text-sm text-blue-700 mt-1">
                We support PDF, DOCX, and DOC formats. Maximum file size is 10MB.
              </p>
            </div>
          </div>
        </CardContent>
