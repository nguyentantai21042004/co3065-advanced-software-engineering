      ...
      <div className="mx-auto flex h-full max-w-6xl items-center justify-between px-4 sm:px-6">
        ...
        <div className="flex items-center gap-8">
          <Link href="/dashboard/upload" className="flex items-center gap-2.5 group">
            <div className="flex h-8.5 w-8.5 items-center justify-center rounded-xl bg-slate-900 text-white shadow-soft-xs group-hover:bg-blue-600 transition-colors">
        ...
        <div className="hidden sm:flex items-center gap-3">
          <div className="flex items-center gap-2 rounded-lg border border-slate-200/80 bg-slate-50 px-2.5 py-1">
