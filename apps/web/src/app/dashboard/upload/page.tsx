    ...
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-slate-500">
          Hỗ trợ các định dạng tệp PDF, Word (.docx, .doc) tối đa 10MB. Quá trình phân tích sẽ khởi động tự động.
        </p>
      </div>

      {/* Main Upload Box */}
      <Card className="p-8 shadow-soft-sm bg-white">
        {status === 'uploading' ? (
          ...
          >
            ...
            <p className="mt-1 text-xs text-slate-500 max-w-sm mx-auto">
              Hoặc duyệt tệp từ máy tính của bạn (.PDF, .DOCX, .DOC tối đa 10MB).
            </p>
      ...
      <Card className="p-5 bg-white shadow-soft-xs">
