...
public class CVProcessingController {
  ...
  public ResponseEntity<ApiResponse<UploadedFileResponse>> uploadCV(
      @Parameter(
          description = "CV file to upload. Supported formats: PDF (.pdf), DOCX (.docx), or DOC (.doc). Maximum file size: 10MB.",
          required = true,
  ...
  @Operation(
      summary = "Extract text from uploaded CV file",
      description = """
  ...
  @ApiResponses(value = {
      @io.swagger.v3.oas.annotations.responses.ApiResponse(
          responseCode = "200",
          description = "Extraction task accepted and queued successfully",
          content = @Content(
              mediaType = "application/json",
              schema = @Schema(implementation = ApiResponse.class),
              examples = @ExampleObject(value = """
      ...
      @io.swagger.v3.oas.annotations.responses.ApiResponse(
          responseCode = "400",
          description = "Bad request - Invalid file_id format or missing",
          content = @Content(
              mediaType = "application/json",
              schema = @Schema(implementation = ApiResponse.class),
              examples = @ExampleObject(value = """
      ...
      @io.swagger.v3.oas.annotations.responses.ApiResponse(
          responseCode = "404",
          description = "File ID not found - The specified file_id does not exist in the database",
          content = @Content(
              mediaType = "application/json",
              schema = @Schema(implementation = ApiResponse.class),
              examples = @ExampleObject(value = """
      ...
      @io.swagger.v3.oas.annotations.responses.ApiResponse(
          responseCode = "500",
          description = "Internal server error - Failed to publish extraction task",
          content = @Content(
              mediaType = "application/json",
              schema = @Schema(implementation = ApiResponse.class),
              examples = @ExampleObject(value = """
  ...
  public ResponseEntity<ApiResponse<String>> extractByUri(
      @Parameter(
          description = "The UUID of the uploaded file to extract text from. Must be a valid UUID format.",
          required = true,
  ...
  @ApiResponses(value = {
      @io.swagger.v3.oas.annotations.responses.ApiResponse(
          responseCode = "200",
          description = "Successfully retrieved list of supported file types",
          content = @Content(
              mediaType = "application/json",
              schema = @Schema(implementation = ApiResponse.class),
              examples = @ExampleObject(value = """
